...
FTS_data = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\0-calibration_fts-accel.csv');
steady_state_accel = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\0-steady-state_accel.csv');
steady_state_wrench = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\0-steady-state_wrench.csv');

baseline_accel = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\2-vibrations_accel.csv');
baseline_orientations = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\2-vibrations_orientations.csv');
baseline_wrench = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\1-baseline_wrench.csv');

vibrations_accel = readtable('..\datasets\2-vibrations_accel.csv');
vibrations_wrench = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\2-vibrations_wrench.csv');
vibrations_orientations = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\2-vibrations_orientations.csv');

vib_contact_accel = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\3-vibrations-contact_accel.csv');
vib_contact_wrench = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\3-vibrations-contact_wrench.csv');
vib_contact_orientations = readtable('C:\Users\hanur\CLionProjects\Cybernetics\AIS2202-estimation-template\datasets\3-vibrations-contact_orientations.csv');
